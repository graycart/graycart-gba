...
| Doc | What it decides |
|-----|-----------------|
| [implementation-plan.md](./implementation-plan.md) | Pages 0–13 greenfield; page 14+ in the complete-emulator plan. Page 18 (`0.2.4`) BIOS math/affine is done. Continue-here is page 19 (`0.2.5`) |
