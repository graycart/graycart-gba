...
| Doc | What it decides |
|-----|-----------------|
| [implementation-plan.md](./implementation-plan.md) | Pages 0–13 greenfield; page 14+ in the complete-emulator plan. Page 19 (`0.2.5`) affine objects is done. Continue-here is page 20 (`0.2.6`) |
