...
| Doc | What it decides |
|-----|-----------------|
| [implementation-plan.md](./implementation-plan.md) | Pages 0–13 greenfield; page 14+ in the complete-emulator plan. Page 20 (`0.2.6`) DMA3 video capture is done. Continue-here is page 21 (`0.2.7`) |
