...
| Doc | What it decides |
|-----|-----------------|
| [implementation-plan.md](./implementation-plan.md) | Pages 0–13 greenfield; page 14+ in the complete-emulator plan. Page 17 (`0.2.3`) decompress is done. Continue-here is page 18 (`0.2.4`) |
