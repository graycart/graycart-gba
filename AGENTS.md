...
- Scaffold started at **`0.0.1`**; first tagged runnable milestone is **`0.1.0`** (P9 playable host). P10 **0.1.1**, P11 **0.1.2**, P12 cutover **0.1.3**, console debug **0.1.4**, AV health summary **0.1.9**, AV health CI gates **0.1.12**.
