...
Same posture as [graycart-gb `AGENTS.md`](https://github.com/graycart/graycart-gb/blob/main/AGENTS.md) and Project store `docs/graycart-gba/08-implementation-plan.md` §5:
...
No emulator core implementation until the research review gate in `08-implementation-plan.md` §7 is accepted. Do not start P1 CPU work during Phase 0 scaffold.
